...
const config = setEnvConfig(readJson(configTemplate));
...
try {
  ...
  execFileSync('python3', ['-m', 'py_compile', 'collect.py', 'poster.py', 'html_poster.py', 'capture_poster.py', 'pose_library.py'], {
    cwd: localRoot, stdio: 'inherit'
  });
